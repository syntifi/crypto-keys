...
public class Ed25519PublicKeyTests extends AbstractCryptoTests {
    ...
    @Test
    void verify_should_work_with_previously_signed_message() throws URISyntaxException, IOException, GeneralSecurityException {
    ...
    @Test
    void verify_should_work_with_unicode_string() throws GeneralSecurityException {
